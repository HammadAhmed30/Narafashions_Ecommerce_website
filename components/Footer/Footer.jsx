            ...
            <div className={`res-1400 ${styles.main_footer}`}>
                <div className={styles.footer_linker_main_cnt}>
                    ...
                    <div className={styles.footer_linker_div}>
                        ...
                        <a className={styles.footer_linker_div_link} href="">Contact</a>
                        <a className={styles.footer_linker_div_link} href="">About</a>
                        <a className={styles.footer_linker_div_link} href="">Browse Our Product</a>
                        <a className={styles.footer_linker_div_link} href="">Collection</a>
                    </div>
                </div>
